...
$gab="<h3>Hasil Perhitungan</h3>";
$gab.="<table border='1'><tr><td>No<td>Hasil Peminatan <td>Ranking</tr>";
for($i=0;$i<$array_count;$i++){
	$no=$i+1;
	$gab.="<tr><td>$no<td>$nhasil[$i]<td>Saran-$no</tr>";
}
$gab.="<table>";
$_SESSION["gab"]=$gab;
...
$keterangan="
<b><h2>Analisa  Saran Jenis Peminatan Adalah : $nout   atau $nout2 </h2></b>";
