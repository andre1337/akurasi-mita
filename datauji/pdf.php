...
$pdf->Cell(2,1,'id_datauji','LR',0,'C',1);
$pdf->Cell(7,1,'k1','LR',0,'C',1);
$pdf->Cell(5,1,'k2','LR',0,'C',1);
$pdf->Cell(3,1,'k3','LR',0,'C',1);
$pdf->Cell(9,1,'k4','LR',0,'C',1);
...
for ($j=0;$j<$i;$j++){
  ...
  $pdf->Cell(2,1,$cell[$j][0],'B',0,'L'); // id_datauji
  $pdf->Cell(7,1,$cell[$j][1],'B',0,'L'); // k1
  $pdf->Cell(5,1,$cell[$j][2],'B',0,'L'); // k2
  $pdf->Cell(3,1,$cell[$j][3],'B',0,'L'); // k3
  $pdf->Cell(9,1,$cell[$j][4],'B',0,'L'); // k4
